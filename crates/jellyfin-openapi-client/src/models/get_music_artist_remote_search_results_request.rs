...
pub struct GetMusicArtistRemoteSearchResultsRequest {
    #[serde(rename = "SearchInfo", skip_serializing_if = "Option::is_none")]
    pub search_info: Option<Box<crate::models::ArtistInfoRemoteSearchQuerySearchInfo>>,
...
impl GetMusicArtistRemoteSearchResultsRequest {
    pub fn new() -> GetMusicArtistRemoteSearchResultsRequest {
