...
/// UpdateDisplayPreferencesRequest : Defines the display preferences for any item that supports them (usually Folders).



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct UpdateDisplayPreferencesRequest {
    ...
    pub scroll_direction: Option<Box<crate::models::ScrollDirection>>,
    ...
    pub sort_order: Option<Box<crate::models::SortOrder>>,
...
impl UpdateDisplayPreferencesRequest {
    /// Defines the display preferences for any item that supports them (usually Folders).
    pub fn new() -> UpdateDisplayPreferencesRequest {
