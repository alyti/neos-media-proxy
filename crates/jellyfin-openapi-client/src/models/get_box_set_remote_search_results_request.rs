...
pub struct GetBoxSetRemoteSearchResultsRequest {
    #[serde(rename = "SearchInfo", skip_serializing_if = "Option::is_none")]
    pub search_info: Option<Box<crate::models::BoxSetInfoRemoteSearchQuerySearchInfo>>,
...
impl GetBoxSetRemoteSearchResultsRequest {
    pub fn new() -> GetBoxSetRemoteSearchResultsRequest {
