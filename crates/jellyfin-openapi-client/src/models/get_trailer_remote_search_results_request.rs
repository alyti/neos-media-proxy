...
pub struct GetTrailerRemoteSearchResultsRequest {
    #[serde(rename = "SearchInfo", skip_serializing_if = "Option::is_none")]
    pub search_info: Option<Box<crate::models::TrailerInfoRemoteSearchQuerySearchInfo>>,
...
impl GetTrailerRemoteSearchResultsRequest {
    pub fn new() -> GetTrailerRemoteSearchResultsRequest {
