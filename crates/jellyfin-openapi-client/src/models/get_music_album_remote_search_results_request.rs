...
pub struct GetMusicAlbumRemoteSearchResultsRequest {
    #[serde(rename = "SearchInfo", skip_serializing_if = "Option::is_none")]
    pub search_info: Option<Box<crate::models::AlbumInfoRemoteSearchQuerySearchInfo>>,
...
impl GetMusicAlbumRemoteSearchResultsRequest {
    pub fn new() -> GetMusicAlbumRemoteSearchResultsRequest {
